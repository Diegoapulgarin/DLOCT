...
def summarize_performance(step, g_model, dataset, n_samples=3):
    path = '/home/dapulgaris/Models/cxpix2pixcomplexexperimentals'
...
folders = ['depth_nail','depth_chicken_breast']
tomTarget = []
tomInput = []
...
for i in range(n_samples):
    ...
    pyplot.subplot(3, n_samples, 1 + i)
    pyplot.axis('off')
    pyplot.imshow(plot0, cmap='hot',aspect='auto')
...
for i in range(n_samples):
    ...
    pyplot.subplot(3, n_samples, 1 + n_samples + i)
    pyplot.axis('off')
    pyplot.imshow(plot1, cmap='hot',aspect='auto')
# plot real target image
for i in range(n_samples):
    # invslice2 = denormalize_bscan(X_realB[i], smax[i,:,0], smin[i,:,0])
    plot2 = (abs((X_realB[i,:,:,0]+1j*X_realB[i,:,:,1])))
    pyplot.subplot(3, n_samples, 1 + n_samples*2 + i)
    pyplot.axis('off')
    pyplot.imshow(plot2, cmap='hot',aspect='auto')
# save plot to file
filename1 = path +'/plot_%06d.png' % (step+1)
pyplot.savefig(filename1)
pyplot.close()
...
# np.save('/home/dapulgaris/Models/cxpix2pixcomplexexperimentals/d_loss1', d_loss1_epoch)
# np.save('/home/dapulgaris/Models/cxpix2pixcomplexexperimentals/d_loss2', d_loss2_epoch)
# np.save('/home/dapulgaris/Models/cxpix2pixcomplexexperimentals/g_loss',  g_loss_epoch)
# np.save('/home/dapulgaris/Models/cxpix2pixcomplexexperimentals/n_epochs', n_epochs)